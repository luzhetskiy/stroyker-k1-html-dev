...
import "../../shared/utils/throttle-debounce/index.js";

import "./legacy/accordion";
import "./legacy/bigSlides";
import "./legacy/catalogViewMode";
import "./legacy/clickEvents";
import "./legacy/customSelect";
import "./legacy/gallery";
import "./legacy/header";
import "./legacy/homeBanner";
import "./legacy/mmenu";
import "./legacy/rangeSlider";
import "./legacy/smoothScroll";
import "./legacy/syncSliders";
import "./legacy/tabs";
