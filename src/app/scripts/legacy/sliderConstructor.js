  ...
  _createClass(SliderConstructor, [
    ...
    },
    {
      ...
      value: function mount() {
        ...
        $(".slider-constructor .product-card-slideshow__sector").on("mousemove", (event) => {
        ...
        $(".slider-constructor .product-card-slideshow__sectors").on("touchstart", (event) => {
          touchstartX = event.changedTouches[0].screenX;
        });

        $(".slider-constructor .product-card-slideshow__sectors").on("touchend", (event) => {
          ...
          if (touchendX < touchstartX) {
            ...
            if (id >= length) {
              parent
              .find(`[data-sector-image="${1}"]`)
              .addClass("product-card-slideshow__image_active");
              parent
              .find(`[data-sector-dot="${1}"]`)
